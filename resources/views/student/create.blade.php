            ...
            <table class="table table-striped table-bordered" id="attribute_wrapper">
                <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="level[]" class="form-control" placeholder="Enter Level" value=""/></td>
                        <td><input type="text" name="college[]" class="form-control" placeholder="Enter College" value=""/></td>
                        <td><input type="text" name="university[]" class="form-control" placeholder="Enter University" value=""/></td>
                        <td><input type="date" name="start_date[]" class="form-control" value=""/></td>
                        <td><input type="date" name="end_date[]" class="form-control"value="" /></td>
